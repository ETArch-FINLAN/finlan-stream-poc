...
public class MjpegInputStream extends DataInputStream {
	...
	*/
	...
	java.util.List<MjpegFrame> cache = new java.util.ArrayList<MjpegFrame>();
	
	public synchronized MjpegFrame readMjpegFrame(int index) throws IOException {
		for(int i=cache.size(); i<=index; i++){
			cache.add(readMjpegFrame());
		}
